...
class Pipeline:
    ...
    def analyse_text(
        ...
        if transcription is None and transcription_path is None:
            raise "Both <transcription> and <transcripton_path> could not be None"
    ...
    def process(self, audio_path, questions_path: str):
        """
        Args:
        ...
        transcription_output_path = "/Users/aslavutin/api-based-mvp/data/tmprhf6goft_transcription.json"  # os.path.join(self.output_path, f"{file_name}_transcription.json")
